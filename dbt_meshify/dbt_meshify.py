...
class DbtMeshModelYmlEditor:
    ...
    def process_model_yml(self, model_yml: str):
        ...
        model_ordered_dict = OrderedDict.fromkeys(["name", "description","latest_version", "access", "config", "meta","columns", "versions"])
    ...
    def add_model_version_to_yml(self, model_name, full_yml_dict, prerelease: Optional[bool] = False, defined_in: Optional[str] = None) -> Dict[str, Any]:
...
class DbtMeshModelConstructor(DbtMeshModelYmlEditor):
    ...
    def add_model_version(self, prerelease: Optional[bool] = False, defined_in: Optional[os.PathLike] = None) -> None:
        """Adds a model version to the model's yaml"""
